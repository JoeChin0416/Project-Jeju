...
function icon(name) {
  const icons = {
    ...
    settings: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3.2" fill="currentColor" opacity=".12"/><path d="M12 8.8a3.2 3.2 0 1 0 0 6.4 3.2 3.2 0 0 0 0-6.4Z"/><path d="M12 4.2v1.6M12 18.2v1.6M5.8 5.8 7 7M17 17l1.2 1.2M4.2 12h1.6M18.2 12h1.6M5.8 18.2 7 17M17 7l1.2-1.2"/><path d="M7.5 9.2 6.4 8l1.7-2.3 1.5.7a6.8 6.8 0 0 1 2.4-.7l.5-1.5h3l.5 1.5c.8.2 1.6.4 2.3.9l1.4-.8 1.7 2.3-1.1 1.2c.1.5.2 1 .2 1.5s-.1 1-.2 1.5l1.1 1.2-1.7 2.3-1.4-.8c-.7.4-1.5.7-2.3.9l-.5 1.5h-3l-.5-1.5a6.8 6.8 0 0 1-2.4-.7l-1.5.7-1.7-2.3 1.1-1.2c-.1-.5-.2-1-.2-1.5s.1-1 .2-1.5Z"/></svg>`,
  };
  return icons[name] || "";
}
