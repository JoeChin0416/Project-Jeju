...
test("normalization keeps non-member admins out of trip members while preserving admin access", () => {
...
test("allows the non-member admin account without adding it as a trip member", () => {
  const result = checkUserAccess(
    { mode: "firebase", authProvider: "google.com", email: "joe.chin@joe.com.tw" },
    { googleWhitelist: [], memberEmails: [], adminEmails: [] },
  );
